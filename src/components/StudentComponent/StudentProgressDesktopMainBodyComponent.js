...
function StudentProgressDesktopMainBodyFunction(){
    ...
    return (
        <div className={"student_dash_all_courses_main_section"}>
            <div className={"student_dash_heading"}>Your progress</div>
                    ...
                    <div className={"col-2 student_progress_menu_main_container"}>
                        ...
                        {allSubjectStudentClassSectionWise?.subjectData?.map((subject, key) => (
                            <div
                                ...
                                key={key} className={"subject_menu_loop_container "+(selectedSubjectTab === subject?.name ? 'active' : '')} style={{background: _getIconBySubjectKey(subject?.name)?.color}}>
                                <div
                                    className={"icon_section"}>
