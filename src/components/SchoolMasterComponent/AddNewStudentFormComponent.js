...
export const AddNewStudentFormComponent = ()=> {
                ...
                <form onSubmit={callFunctionToSubmit}>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            value={name}
                            type="name" className="form-control" aria-describedby="emailHelp" placeholder="Student name" required/>
                    </div>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            value={email}
                            type="email" className="form-control" aria-describedby="emailHelp" placeholder="Student email" required/>
                    </div>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            value={mobile}
                            type="number" className="form-control" aria-describedby="emailHelp" placeholder="Student mobile number" required/>
                    </div>
                    <div className="form-group">
