...
function AllStudentProgressAppMainBodyFunction(){
            ...
            {(studentData) ?
                <>
                    <div className={"student_app_main_body_container_header_section"}>
                        <div>{studentData?.name} Progress</div>
                    ...
                    <div className={"student_app_main_body_container_sub_pages_inner"}>
                        <div className={"all_subject_menu_container"}>
                            <div
                                className={"all_subject_loop_section all_section " + (selectedSubjectTab === 'All Subjects' ? 'active' : '')}>
                                <div
                ...
                :
                <div className={"student_dash_select_input_section_main_container app_view"}>
                    {(!selectedClassData) ?
...
export const AllStudentProgressAppMainBody = React.memo(AllStudentProgressAppMainBodyFunction);
