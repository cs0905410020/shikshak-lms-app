...
export const AddNewAdminFormComponent = ()=> {
                ...
                <form onSubmit={callFunctionToSubmit}>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            value={name}
                            type="name" className="form-control" aria-describedby="emailHelp" placeholder="Admin name" required/>
                    </div>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            value={email}
                            type="email" className="form-control" aria-describedby="emailHelp" placeholder="Admin email" required/>
                    </div>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            value={mobile}
                            type="number" className="form-control" aria-describedby="emailHelp" placeholder="Admin mobile number" required/>
                    </div>
                    <div className="form-group">
