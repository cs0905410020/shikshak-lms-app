...
export const actionToToGetApiResponseForTextSearchApiCall = (body) => {
    const {searchText} = body;
    const appUrl = `https://serpapi.com/search?engine=google&q=${searchText}&gl=us&hl=en&api_key=${serpApiKey}&async=false`;
